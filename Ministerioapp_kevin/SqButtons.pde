      ...
      switch(ID){
        ...
        case 3:    //Submenú Aymara || Madre tierra
          ...
          if(j==0){
            ...
            p10.setMediaFile("a310.mp3"); p10.setLooping(false);  p10.setVolume(1.0, 1.0);
        ...
        case 13:   //Submenú Quechua || Conociéndonos
          ...
          if(j==0){
            ...
            contenidoButtons[i] = new ImageButtons(i,0,0,jaqaru_base[0],jaqaru_file[i++],true,"¿Hayk’a watayuqmi kachkanki?",p1); //Conociéndonos || 8 || ¿Cuántos años tienes?
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"___ watayuq",p1);                  //Conociéndonos || 9 || Yo tengo
            contenidoButtons[i] = new ImageButtons(i,0,0,jaqaru_base[0],jaqaru_file[i++],true,"¿Maymanta kanki?",p1);             //Conociéndonos || 10 || ¿De dónde eres?
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"___manta kani",p1);                //Conociéndonos || 11 || Yo soy de 
        ...
        case 15:   //Submenú Quechua || Madre tierra
          ...
          if(j==0){
            ...
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[1],jaqaru_base[i++],false,"Mayu",p1);     //Madre tierra || 35 || Río 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[2],jaqaru_base[i++],false,"Phuyu",p1);    //Madre tierra || 34 || Nubes
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"Para",p1);     //Madre tierra || 35 || Lluvia
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[4],jaqaru_base[i++],false,"Wasi",p1);     //Madre tierra || 34 || Casa
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[5],jaqaru_base[i++],false,"Mikhuna",p1);  //Madre tierra || 35 || Comida
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[6],jaqaru_base[i++],false,"Inti",p1);     //Madre tierra || 34 || Sol
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[7],jaqaru_base[i++],false,"Killa",p1);    //Madre tierra || 35 || Luna 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[8],jaqaru_base[i++],false,"Ch’aska",p1);  //Madre tierra || 34 || Estrellas
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[9],jaqaru_base[i++],false,"Nina",p1);     //Madre tierra || 35 || Fuego 
            j=1;
          }
          //////////////////////////////////////////
          activity = 109;
        ...
        case 19:   //Submenú Shipibo || Conociéndonos
          ...
          if(j==0){
            ...
            contenidoButtons[i] = new ImageButtons(i,0,0,jaqaru_base[0],jaqaru_file[i++],true,"¿Jaweti baritianri mia?",p1);     //Conociéndonos || 8 || ¿Cuántos años tienes?
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"Eariki ___ baritia",p1);          //Conociéndonos || 9 || Yo tengo
            contenidoButtons[i] = new ImageButtons(i,0,0,jaqaru_base[0],jaqaru_file[i++],true,"¿Jawerato jemankoniarin mia?",p1);//Conociéndonos || 10 || ¿De dónde eres?
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"Eariki ___",p1);                  //Conociéndonos || 11 || Yo soy de 
        ...
        case 21:   //Submenú Shipibo || Madre tierra
          ...
          if(j==0){
            ...
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[1],jaqaru_base[i++],false,"Paro",p1);      //Madre tierra || 35 || Río 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[2],jaqaru_base[i++],false,"Nai koin",p1);  //Madre tierra || 34 || Nubes
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"Oi",p1);        //Madre tierra || 35 || Lluvia
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[4],jaqaru_base[i++],false,"Xobo",p1);      //Madre tierra || 34 || Casa
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[5],jaqaru_base[i++],false,"Piti",p1);      //Madre tierra || 35 || Comida
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[6],jaqaru_base[i++],false,"Bari",p1);      //Madre tierra || 34 || Sol
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[7],jaqaru_base[i++],false,"Oxe",p1);       //Madre tierra || 35 || Luna 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[8],jaqaru_base[i++],false,"Wishtinbo",p1); //Madre tierra || 34 || Estrellas
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[9],jaqaru_base[i++],false,"Chií tiri",p1); //Madre tierra || 35 || Fuego 
            j=1;
          }
          //////////////////////////////////////////
          activity = 148;
        ...
        case 22:   //Submenú Shipibo || Animales
          ...
          if(j==0){
            ...
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"Ochiti",p4);     //Animales || Perro
        ...
        case 25:   //Submenú Matsiguenka || Conociéndonos
          ...
          if(j==0){
            ...
            contenidoButtons[i] = new ImageButtons(i,0,0,jaqaru_base[0],jaqaru_file[i++],true,"¿Akati pishiriagakotanaka?",p1);              //Conociéndonos || 8 || ¿Cuántos años tienes?
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"Naro noshiriagakotanaka ___ shiriagarini",p1);//Conociéndonos || 9 || Yo tengo
            contenidoButtons[i] = new ImageButtons(i,0,0,jaqaru_base[0],jaqaru_file[i++],true,"¿Tyara piponiaka?",p1);                       //Conociéndonos || 10 || ¿De dónde eres?
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"Naro noponiaka ___",p1);                      //Conociéndonos || 11 || Yo soy de 
        ...
        case 27:   //Submenú Matsiguenka || Madre tierra
          ...
          if(j==0){
            ...
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[1],jaqaru_base[i++],false,"Eni",p1);                  //Madre tierra || 35 || Río 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[2],jaqaru_base[i++],false,"Menkori",p1);              //Madre tierra || 34 || Nubes
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"Inkani",p1);               //Madre tierra || 35 || Lluvia
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[4],jaqaru_base[i++],false,"Pankotsi",p1);             //Madre tierra || 34 || Casa
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[5],jaqaru_base[i++],false,"Sekatsi",p1);              //Madre tierra || 35 || Comida
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[6],jaqaru_base[i++],false,"Poreatsiri",p1);           //Madre tierra || 34 || Sol
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[7],jaqaru_base[i++],false,"Kashiri",p1);              //Madre tierra || 35 || Luna 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[8],jaqaru_base[i++],false,"Impokiro/impokiropage",p1);//Madre tierra || 34 || Estrellas
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[9],jaqaru_base[i++],false,"Morekari",p1);             //Madre tierra || 35 || Fuego 
            j=1;
          }
          //////////////////////////////////////////
          activity = 187;
        ...
        case 31:   //Submenú Yine || Conociéndonos
          ...
          if(j==0){
            ...
            contenidoButtons[i] = new ImageButtons(i,0,0,jaqaru_base[0],jaqaru_file[i++],true,"¿Gipejnu walapu wanenyi?",p1); //Conociéndonos || 8 || ¿Cuántos años tienes?
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"Pamyomole walapu wanenyno",p1);//Conociéndonos || 9 || Yo tengo
            contenidoButtons[i] = new ImageButtons(i,0,0,jaqaru_base[0],jaqaru_file[i++],true,"¿Ginakgajeryi?",p1);           //Conociéndonos || 10 || ¿De dónde eres?
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"Miariya gajerno gita",p1);     //Conociéndonos || 11 || Yo soy de 
        ...
        case 33:   //Submenú Yine || Madre tierra
          ...
          if(j==0){
            ...
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[1],jaqaru_base[i++],false,"Tsruru",p1);    //Madre tierra || 35 || Río 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[2],jaqaru_base[i++],false,"Kamkolu",p1);   //Madre tierra || 34 || Nubes
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"Gina",p1);      //Madre tierra || 35 || Lluvia
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[4],jaqaru_base[i++],false,"Panchi",p1);    //Madre tierra || 34 || Casa
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[5],jaqaru_base[i++],false,"Niikaluru",p1); //Madre tierra || 35 || Comida
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[6],jaqaru_base[i++],false,"Tkachi",p1);    //Madre tierra || 34 || Sol
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[7],jaqaru_base[i++],false,"Ksuru",p1);     //Madre tierra || 35 || Luna 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[8],jaqaru_base[i++],false,"Katagiri",p1);  //Madre tierra || 34 || Estrellas
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[9],jaqaru_base[i++],false,"Katalu",p1);    //Madre tierra || 35 || Fuego 
            j=1;
          }
          //////////////////////////////////////////
          activity = 226;
